...
import "./last-row.style.css";

const LastRow = () => {
  return (
    <Container id="lastRow">
      <div id="lastElements">
        <small id="smallText">
          {" "}
          کلیه حقوق این سرویس (وب‌سایت و اپلیکیشن‌های موبایل) محفوظ و متعلق به
          شرکت سفرهای علی‌بابا می‌باشد. <span dir="ltr"> (نسخه 2.39.3) </span>
        </small>
        <div id="logos">
          <a
            href="#AlibabaTravels"
            className="align-middle text-center w-5 mx-3"
          ...
          <a
            href="#youtube"
            className="d-inline-block align-middle text-center w-5 mx-3"
            rel="noopener noreferrer"
            target="_blank"
          >
            <svg
